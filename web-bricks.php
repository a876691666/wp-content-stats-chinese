...
class WBCS
{
    ...
    function createHTML($content)
    {
        ...
        // Character Count View
		  $html .= esc_html__('此文章有', 'wbcontentstats') . '  ' . strlen(strip_tags($content)) . '  ' . esc_html__('个字符', 'wbcontentstats') . ', ' . esc_html__('大约要花', 'wbcontentstats') . '  ' . round(strlen(strip_tags($content)) / 225) . '  ' . esc_html__('分钟阅读', 'wbcontentstats') . '<br>';
